  ...
  return (
    <div>
      ...
      >
        <p>ข้อมูลผู้ใช้</p>
        {!isRegistor ? (
          <p style={{ color: "red" }}>กรุณากรอกข้อมูลผู้ใช้</p>
        ) : undefined}
        ...
        <FormGroup style={{ width: "100%" }} row>
          ...
          <Input
            ...
            required
            onChange={(val) =>
              setData({ ...data, firstname: val.target.value })
            }
          />
          <FormFeedback style={{ marginTop: "-1rem" }}>
        ...
        <FormGroup style={{ width: "100%" }} row>
          ...
          {disabled ? (
            ...
            <Input
              ...
              required
              onChange={(val) =>
                setData({ ...data, karnfaifa: val.target.value })
              }
            >
